...
namespace Quick.Onvif.ReplayControl
{
    ...
    public interface ReplayPort
    {
        ...
        System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.Capabilities> GetServiceCapabilitiesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.onvif.org/ver10/replay/wsdl/GetReplayUri", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.GetReplayUriResponse> GetReplayUriAsync(Quick.Onvif.ReplayControl.GetReplayUriRequest request);
        ...
        System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.ReplayConfiguration> GetReplayConfigurationAsync();
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task SetReplayConfigurationAsync(Quick.Onvif.ReplayControl.ReplayConfiguration Configuration);
    }
    ...
    public partial class GetReplayUriRequest
    {
        ...
        public Quick.Onvif.ReplayControl.StreamSetup StreamSetup;
        ...
        public GetReplayUriRequest(Quick.Onvif.ReplayControl.StreamSetup StreamSetup, string RecordingToken)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface ReplayPortChannel : Quick.Onvif.ReplayControl.ReplayPort, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class ReplayPortClient : System.ServiceModel.ClientBase<Quick.Onvif.ReplayControl.ReplayPort>, Quick.Onvif.ReplayControl.ReplayPort
    {
        ...
        public System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.Capabilities> GetServiceCapabilitiesAsync()
        {
            return base.Channel.GetServiceCapabilitiesAsync();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.GetReplayUriResponse> Quick.Onvif.ReplayControl.ReplayPort.GetReplayUriAsync(Quick.Onvif.ReplayControl.GetReplayUriRequest request)
        {
            return base.Channel.GetReplayUriAsync(request);
        }
        
        public System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.GetReplayUriResponse> GetReplayUriAsync(Quick.Onvif.ReplayControl.StreamSetup StreamSetup, string RecordingToken)
        {
            Quick.Onvif.ReplayControl.GetReplayUriRequest inValue = new Quick.Onvif.ReplayControl.GetReplayUriRequest();
            inValue.StreamSetup = StreamSetup;
            inValue.RecordingToken = RecordingToken;
            return ((Quick.Onvif.ReplayControl.ReplayPort)(this)).GetReplayUriAsync(inValue);
        }
        
        public System.Threading.Tasks.Task<Quick.Onvif.ReplayControl.ReplayConfiguration> GetReplayConfigurationAsync()
        {
            return base.Channel.GetReplayConfigurationAsync();
        }
        
        public System.Threading.Tasks.Task SetReplayConfigurationAsync(Quick.Onvif.ReplayControl.ReplayConfiguration Configuration)
        {
