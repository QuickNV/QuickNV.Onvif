...
using QuickNV.Onvif.TestUI.Utils;
using System.Diagnostics;
using System.Text;

namespace QuickNV.Onvif.TestUI
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(OnvifClient client)
        {
            ...
            imagingPortClient = new Imaging.ImagingPortClient(client);
        ...
        private async Task ptzFocusMove(float focusSpeed)
        {
            try
            {
                await imagingPortClient.MoveAsync(currentProfile.VideoSourceConfiguration.SourceToken, new Imaging.FocusMove()
                {
                    Continuous = new Imaging.ContinuousFocus()
                    {
                        Speed = focusSpeed
                    }
                });
