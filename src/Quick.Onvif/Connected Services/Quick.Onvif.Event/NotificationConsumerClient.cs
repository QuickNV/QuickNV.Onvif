...
namespace Quick.Onvif.Event
{
    ...
    {
        public NotificationConsumerClient(string url, string username, string password, HttpClientCredentialType clientCredentialType = HttpClientCredentialType.Digest)
                    : base(
