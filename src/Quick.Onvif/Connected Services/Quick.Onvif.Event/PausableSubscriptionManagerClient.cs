...
namespace Quick.Onvif.Event
{
    ...
    {
        public PausableSubscriptionManagerClient(string url, string username, string password, HttpClientCredentialType clientCredentialType = HttpClientCredentialType.Digest)
                    : base(
